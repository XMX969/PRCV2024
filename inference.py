'''
CUDA_VISIBLE_DEVICES=1 python inference.py --model_names ISTDU-Net --dataset_names WideIRSTD --pth_dirs WideIRSTD/Dataset-mask_ISTDU-Net_100.pth.tar --img_norm_cfg_mean 107.848 --img_norm_cfg_std 30.905
'''
